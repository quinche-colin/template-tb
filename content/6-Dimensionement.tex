...
\begin{table}[H]
  ...
  \end{tabular}
\end{table}
\textbf{Résumé de l'acquisition~:} Le système optique offre une résolution de 18,6 $\mu$m/pixel sur un champ de 48 x 48 mm, avec une distance de travail de 250 mm et un éclairage rasant homogène.
...
\begin{align*}
  \text{Mvt19} &: 8{,}73 - 4{,}1 = 4{,}63\ \text{mm} \\
  \text{Mvt01} &: 7{,}23 - 2{,}8 = 4{,}43\ \text{mm} \\
  \text{Mvt200} &: 6{,}63 - 2{,}2 = 4{,}43\ \text{mm} \\
  \text{Mvt200.1} &: 8{,}63 - 4{,}2 = 4{,}43\ \text{mm} \\
  \text{Mvt110} &: 3{,}80 - 1{,}5 = 2{,}30\ \text{mm} \\
  \text{Mvt111} &: 3{,}05 - 1{,}0 = 2{,}05\ \text{mm}
\end{align*}

La différence entre la hauteur maximale (Mvt19 : $4{,}63\ \text{mm}$) et minimale (Mvt111 : $2{,}05\ \text{mm}$) s'élève à :

\begin{equation}
  \Delta h = 4{,}63 - 2{,}05 = 2{,}58\ \text{mm}
  \label{eq:delta_h}
\end{equation}
...
goupilles diamétralement opposées, qui viennent alternativement entraîner la fourche en T~:
sur un tour moteur complet, une goupille entraîne la fourche en T durant 180°, puis c'est au tour de la seconde goupille, et ainsi de suite.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{assets/figures/Implementation/fig_positions_angle.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{assets/figures/Implementation/fig_beta_evolution.png}
  ...
  ($\Delta h = 2{,}58$~mm) se situe entre les courbes $e=2$~mm et $e=3$~mm.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{assets/figures/Implementation/fig_delta_evolution.png}
...
Avec $e = \Delta h = 2{,}58\ \text{mm}$ et $R=12{,}5\ \text{mm}$ :

\begin{equation}
  \varepsilon_{\text{min}} = -\frac{2{,}58}{15{,}08} \approx -17{,}1\ \%, \qquad
  \varepsilon_{\text{max}} = \frac{2{,}58}{9{,}92} \approx 26{,}0\ \%
...
brusque de $+26{,}0\ \%$ à $-17{,}1\ \%$ toutes les 180° de rotation moteur
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{assets/figures/Implementation/fig_profil_remontage.png}
  \caption{Profil de vitesse réel en mode réserve de marche (Mvt01), avec
  saccade périodique due au désalignement $e=\Delta h=2{,}58$~mm.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{assets/figures/Implementation/fig_profil_vieillissement.png}
...
Dans les deux cas, la vitesse instantanée croît jusqu'à $+26\ \%$ au-dessus de
la consigne puis chute à $-17\ \%$ en dessous, à chaque changement de
...
$e=\Delta h=2{,}58\ \text{mm}$ et $R=12{,}5\ \text{mm}$, on obtient les
...
\begin{align}
  ...
  \alpha &= \arccos\!\left(-\frac{e}{R}\right) = \arccos\!\left(-\frac{2{,}58}{12{,}5}\right) \approx 101{,}91°
...
\begin{equation}
  \Delta\theta_{\text{max}} = 90° - 101{,}91° = -11{,}91°
  \label{eq:delta_max}
\end{equation}

Cet extremum est atteint 2 fois lors d'un tour lorsque $\alpha=101{,}9°$ et $\alpha=281{,}9°$.
...
$\Delta\theta_{\text{max}}=11{,}91°$ (équation~\eqref{eq:delta_max})
...
\begin{equation}
  ...
  = \frac{11{,}91}{360}\times 2{,}33 \approx 0{,}0771\ \text{h} \approx 4{,}63\ \text{min}
  \label{eq:dt_max}
\end{equation}
...
\begin{table}[H]
  \centering
  \caption{Imprécision de mesure induite par le désalignement réel ($e=\Delta h=2{,}58$~mm)}
  ...
  \begin{tabular}{|c|c|c|c|}
    ...
    \hline
    Mvt19    & 100 & 47{,}12 & 4{,}21 \\
    Mvt01    & 80  & 34{,}30 & 4{,}63 \\
    Mvt200   & 90  & 43{,}96 & 4{,}06 \\
    Mvt200.1 & 90  & 43{,}96 & 4{,}06 \\
    Mvt110   & 90  & 68{,}16 & 2{,}62 \\
    Mvt111   & 89  & 41{,}44 & 4{,}26 \\
    \hline
  \end{tabular}
\end{table}

L'imprécision de mesure induite par le désalignement réel de l'accouplement
reste comprise entre $2{,}6$ et $4{,}6$ minutes selon le mouvement, ce qui
...
mesure sur un tour moteur complet au désalignement réel ($e=2{,}58$~mm) à
ce désalignement limite ($e=7{,}80$~mm)~: la courbe limite touche tout juste
$-15$~min, contre $-4{,}6$~min pour le cas réel.

\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{assets/figures/Implementation/fig_precision_e_limite.png}
  \caption{Imprécision de mesure sur un tour moteur complet pour le Mvt01
  (cas le plus défavorable), au désalignement réel ($e=2{,}58$~mm) et au
