...
\begin{enumerate}
    \item \textbf{Système de fixation~:} maintien du mouvement en position stable pendant toute la durée du test.
    \item \textbf{Système de motorisation~:} entraînement contrôlé de la tige de remontoir, avec limitation du couple appliqué sur le mouvement.
    \item \textbf{Système d'accouplement~:} liaison mécanique entre l'arbre moteur et la tige du mouvement, sans transmission d'efforts radiaux.
    \item \textbf{Système d'acquisition optique~:} prise de vue périodique du mouvement permettant de détecter automatiquement son arrêt.
\end{enumerate}
...
Il accueille l'ensemble des calibres définis dans le cahier des charges et permet un montage en moins de deux minutes, sans outillage, sans exercer d'effort sur les composants délicats du mouvement.

\begin{figure}[H]
    \centering
    \fbox{\parbox{0.65\textwidth}{\centering\vspace{2.5cm}\textit{[Photo : porte-mouvement avec calibre en position]}\vspace{2.5cm}}}
...
\begin{figure}[H]
    \centering
    \fbox{\parbox{0.65\textwidth}{\centering\vspace{2.5cm}\textit{[Photo : moteur NEMA 11 monté sur la structure]}\vspace{2.5cm}}}
