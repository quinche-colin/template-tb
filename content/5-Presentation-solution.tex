...
Cette solution est déjà utilisée régulièrement et a même été recommandée par Breitling.
Par conséquent, cette solution de fixation semble idéale pour le projet.
...
La fourche en T, solidaire à la tige du mouvement, vient s'engager dans la fourche en U montée sur l'arbre moteur.
...
Ce principe transmet le couple de rotation tout en évitant de transmettre les forces parasites provoquées par les charges radiales et les légères erreurs d'alignement entre les deux axes. Ce mécanisme protège ainsi le mouvement.

\section{Système d'acquisition optique}
\label{sec:acquisition_optique}

Une caméra industrielle est fixée au-dessus du mouvement à une distance de travail de 250 mm (figure~\ref{fig:camera_proto}).
